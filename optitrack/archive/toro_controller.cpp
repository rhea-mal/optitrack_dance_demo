...
void control(std::shared_ptr<Optitrack::Human> human,
    ...
    for (int i = 0; i < primary_control_links.size(); ++i) {        
        ...
        primary_tasks[primary_control_links[i]] = std::make_shared<Sai2Primitives::MotionForceTask>(robot, primary_control_links[i], compliant_frame, primary_control_links[i]);
    ...
    for (int i = 0; i < secondary_control_links.size(); ++i) {        
        ...
        if (secondary_control_links[i] == "la_link4" || secondary_control_links[i] == "ra_link4") {
            secondary_tasks[secondary_control_links[i]] = std::make_shared<Sai2Primitives::MotionForceTask>(robot, secondary_control_links[i], compliant_frame, secondary_control_links[i]);        
        } else {
            secondary_tasks[secondary_control_links[i]] = std::make_shared<Sai2Primitives::MotionForceTask>(robot, secondary_control_links[i], controlled, uncontrolled, compliant_frame, secondary_control_links[i]);
        }
        ...
        // secondary_tasks[secondary_control_links[i]]->setDynamicDecouplingType(Sai2Primitives::IMPEDANCE);
