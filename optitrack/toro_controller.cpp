...
void control(std::shared_ptr<Optitrack::Human> human,
	...
	while (runloop) {
        ...
        for (int i = 0; i < NUM_RIGID_BODIES; ++i) {
            ...
            Eigen::Vector3d current_position = redis_client.getEigen("1::" + std::to_string(index) + "::pos");
            Eigen::MatrixXd quaternion_matrix = redis_client.getEigen("1::" + std::to_string(index) + "::ori");
